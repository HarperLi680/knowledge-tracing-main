...
def train_predict_BKT_Forgetting(train_data, test_data):
    """
    Explicit entrypoint for the pyBKT forgetting variant
    """
    return train_predict_BKT(train_data=train_data, test_data=test_data)
